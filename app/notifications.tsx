...
export default function NotificationsScreen() {
  ...
  const load = useCallback(async () => { try { setItems(await getNotifications()); } finally { setLoading(false); } }, []);
